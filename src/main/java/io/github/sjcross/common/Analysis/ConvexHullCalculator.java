...
//import io.github.sjcross.common.Object.Volume;
//
...
//        Volume insideHull = new Volume(VolumeType.POINTLIST,volume.getDistPerPxXY(),volume.getDistPerPxZ(),volume.getUnits(),volume.is2D());
//
