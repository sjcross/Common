...
public class OcTreeVolumeTest
{
    ...
    public void testAddCoordAlreadyExists() throws IntegerOverflowException {
        ...
        OcTreeVolume volume = new OcTreeVolume(10,10,1,dppXY,dppZ,units);
        volume.add(0,0,0);
        volume.add(0,0,0);
        volume.add(1,0,0);
    ...
    public void testGetXCoords() throws IntegerOverflowException {
        OcTreeVolume volume = new OcTreeVolume(10,10,13,2.0,1.0,"PX");
        volume.add(1,2,3);
        volume.add(4,3,12);
        volume.add(2,1,2);
        volume.add(1,2,5);
    ...
    @Test
    public void testGetXNoOcTreeVolume() {
        double dppXY = 0.02;
        double dppZ = 0.1;
        String units = "um";

        OcTreeVolume volume = new OcTreeVolume(10,10,13,dppXY,dppZ,units);
    ...
    public void testGetXPixelDistances() throws IntegerOverflowException {
        ...
        OcTreeVolume volume = new OcTreeVolume(20,10,5,dppXY,dppZ,units);
        volume.add(10,5,1);
        volume.add(10,5,2);
        volume.add(11,5,2);
        volume.add(13,7,1);
    ...
    public void testCalculateAngle2DTopRight() throws IntegerOverflowException {
        ...
        OcTreeVolume volume1 = new OcTreeVolume(20,20,1,dppXY,dppZ,units);
        volume1.add(0,0,0);

        OcTreeVolume volume2 = new OcTreeVolume(20,20,1,dppXY,dppZ,units);
        volume2.add(10,10,0);
    ...
    public void testCalculateAngle2DTopLeft() throws IntegerOverflowException {
        ...
        OcTreeVolume volume1 = new OcTreeVolume(20,11,5,dppXY,dppZ,units);
        volume1.add(5,5,0);

        OcTreeVolume volume2 = new OcTreeVolume(20,11,5,dppXY,dppZ,units);
        volume2.add(0,10,0);
    ...
    public void testCalculateAngle2DPositiveXAxis() throws IntegerOverflowException {
        ...
        OcTreeVolume volume1 = new OcTreeVolume(20,10,5,dppXY,dppZ,units);
        volume1.add(0,0,0);

        OcTreeVolume volume2 = new OcTreeVolume(20,10,5,dppXY,dppZ,units);
        volume2.add(5,0,0);
    ...
    @Test
    public void testHasVolumeNoOcTreeVolume() {
        double dppXY = 0.02;
        double dppZ = 0.1;
        String units = "um";
    ...
    public void testContainsPointDoesContain() throws IntegerOverflowException {
        OcTreeVolume volume = new OcTreeVolume(10,5,15,2.0,1.0,"PX");
        volume.add(1,2,3);
        volume.add(4,3,12);
        volume.add(2,1,2);
        volume.add(1,2,5);
    ...
    public void testHashCodeDifferentValue() throws IntegerOverflowException {
        OcTreeVolume volume1 = new OcTreeVolume(5,4,13,1.0,1.0,"Test");
        volume1.add(1,2,3);
        volume1.add(4,3,12);
        volume1.add(2,1,2);
        volume1.add(1,2,5);

        OcTreeVolume volume2 = new OcTreeVolume(5,4,13,1.0,1.0,"Test");
        volume2.add(1,2,3);
        volume2.add(0,3,12);
        volume2.add(2,1,2);
        volume2.add(1,2,5);
    ...
    public void testHashCodeDifferentPointOrder() throws IntegerOverflowException {
        ...
        OcTreeVolume volume1 = new OcTreeVolume(10,10,20,2.0,1.0,"Test");
        volume1.add(1,2,3);
        volume1.add(4,3,12);
        volume1.add(2,1,2);
        volume1.add(1,2,5);

        OcTreeVolume volume2 = new OcTreeVolume(10,10,20,2.0,1.0,"Test");
        volume2.add(1,2,3);
        volume2.add(4,3,12);
        volume2.add(2,1,2);
        volume2.add(1,2,5);

        OcTreeVolume volume3 = new OcTreeVolume(10,10,20,2.0,1.0,"Test");
        volume3.add(2,1,2);
        volume3.add(1,2,3);
        volume3.add(4,3,12);
        volume3.add(1,2,5);
    ...
    public void testHashCodeDifferentCalibration() throws IntegerOverflowException {
        OcTreeVolume volume1 = new OcTreeVolume(10,10,20,2.0,1.0,"PX");
        volume1.add(1,2,3);
        volume1.add(4,3,12);
        volume1.add(2,1,2);
        volume1.add(1,2,5);

        OcTreeVolume volume2 = new OcTreeVolume(10,10,20,2.1,1.0,"PX");
        volume2.add(1,2,3);
        volume2.add(4,3,12);
        volume2.add(2,1,2);
        volume2.add(1,2,5);
    ...
    public void testHashCodeDifferentUnitsCase() throws IntegerOverflowException {
        ...
        OcTreeVolume volume2 = new OcTreeVolume(10,10,20,2.0,1.0,"px");
        volume2.add(1,2,3);
        volume2.add(4,3,12);
        volume2.add(2,1,2);
        volume2.add(1,2,5);
    ...
    public void testHashCodeDifferentUnits() throws IntegerOverflowException {
        ...
        OcTreeVolume volume2 = new OcTreeVolume(10,10,20,2.0,1.0,"um");
        volume2.add(1,2,3);
        volume2.add(4,3,12);
        volume2.add(2,1,2);
        volume2.add(1,2,5);
    ...
    public void testEqualsDifferentPointOrder() throws IntegerOverflowException {// Verifying that the order of point placement doesn't matter
        ...
        OcTreeVolume volume3 = new OcTreeVolume(10,10,20,2.0,1.0,"PX");
        volume3.add(2,1,2);
        volume3.add(1,2,3);
        volume3.add(4,3,12);
        volume3.add(1,2,5);
    ...
    public void testGetOverlappingPointsWithOverlap() throws IntegerOverflowException {
        ...
        assertTrue(actual instanceof OcTreeVolume);
    ...
    public void testClearSurface() throws IntegerOverflowException {
        OcTreeVolume volume = new OcTreeVolume(10,7,15,2.0,1.0,"PX");
        volume.add(1,2,3);
        volume.add(4,3,12);
        volume.add(2,1,2);
        volume.add(1,2,5);
    ...
    public void testGetSurface() throws IntegerOverflowException {
        OcTreeVolume volume = new OcTreeVolume(10,10,8,2.0,1.0,"PX");
        volume.add(5,7,3);
        volume.add(5,8,3);
        volume.add(5,9,3);
        volume.add(6,7,3);
    ...
    public void testPerformance() {
        ...
        OcTreeVolume ocTreeVolume = new OcTreeVolume(512,512,10,1,1,"px");

        long t1 = System.nanoTime();
        for (int z=0;z<10;z++) {
            for (Integer[] coord : coords) ocTreeVolume.add(coord[0], coord[1], z);
        }
        long t2 = System.nanoTime();
        ocTreeVolume.finalise();
        long t3 = System.nanoTime();
        for (Point<Integer> point:ocTreeVolume);
