...
public class PointListVolumeTest {
    ...
    public void testAddCoordAlreadyExists() throws IntegerOverflowException {
        ...
        Volume volume = new Volume(VolumeType.POINTLIST,10,10,1,dppXY,dppZ,units);
        volume.add(0,0,0);
        volume.add(0,0,0);
        volume.add(1,0,0);
    ...
    public void testGetXCoords() throws IntegerOverflowException {
        Volume volume = new Volume(VolumeType.POINTLIST,10,10,13,2.0,1.0,"PX");
        volume.add(1,2,3);
        volume.add(4,3,12);
        volume.add(2,1,2);
        volume.add(1,2,5);
    ...
    public void testGetXNoVolume2() {
        ...
        Volume volume = new Volume(VolumeType.POINTLIST,10,10,13,dppXY,dppZ,units);
    ...
    public void testGetXPixelDistances() throws IntegerOverflowException {
        ...
        Volume volume = new Volume(VolumeType.POINTLIST,20,10,5,dppXY,dppZ,units);
        volume.add(10,5,1);
        volume.add(10,5,2);
        volume.add(11,5,2);
        volume.add(13,7,1);
    ...
    public void testCalculateAngle2DTopRight() throws IntegerOverflowException {
        ...
        Volume volume1 = new Volume(VolumeType.POINTLIST,20,20,1,dppXY,dppZ,units);
        volume1.add(0,0,0);

        Volume volume2 = new Volume(VolumeType.POINTLIST,20,20,1,dppXY,dppZ,units);
        volume2.add(10,10,0);
    ...
    public void testCalculateAngle2DTopLeft() throws IntegerOverflowException {
        ...
        Volume volume1 = new Volume(VolumeType.POINTLIST,20,11,5,dppXY,dppZ,units);
        volume1.add(5,5,0);

        Volume volume2 = new Volume(VolumeType.POINTLIST,20,11,5,dppXY,dppZ,units);
        volume2.add(0,10,0);
    ...
    public void testCalculateAngle2DPositiveXAxis() throws IntegerOverflowException {
        ...
        Volume volume1 = new Volume(VolumeType.POINTLIST,20,10,5,dppXY,dppZ,units);
        volume1.add(0,0,0);

        Volume volume2 = new Volume(VolumeType.POINTLIST,20,10,5,dppXY,dppZ,units);
        volume2.add(5,0,0);
    ...
    public void testContainsPointDoesContain() throws IntegerOverflowException {
        Volume volume = new Volume(VolumeType.POINTLIST,10,5,15,2.0,1.0,"PX");
        volume.add(1,2,3);
        volume.add(4,3,12);
        volume.add(2,1,2);
        volume.add(1,2,5);
    ...
    public void testHashCodeDifferentValue() throws IntegerOverflowException {
        Volume volume1 = new Volume(VolumeType.POINTLIST,5,4,13,1.0,1.0,"Test");
        volume1.add(1,2,3);
        volume1.add(4,3,12);
        volume1.add(2,1,2);
        volume1.add(1,2,5);

        Volume volume2 = new Volume(VolumeType.POINTLIST,5,4,13,1.0,1.0,"Test");
        volume2.add(1,2,3);
        volume2.add(0,3,12);
        volume2.add(2,1,2);
        volume2.add(1,2,5);
    ...
    public void testHashCodeDifferentPointOrder() throws IntegerOverflowException {
        ...
        Volume volume1 = new Volume(VolumeType.POINTLIST,10,10,20,2.0,1.0,"Test");
        volume1.add(1,2,3);
        volume1.add(4,3,12);
        volume1.add(2,1,2);
        volume1.add(1,2,5);

        Volume volume2 = new Volume(VolumeType.POINTLIST,10,10,20,2.0,1.0,"Test");
        volume2.add(1,2,3);
        volume2.add(4,3,12);
        volume2.add(2,1,2);
        volume2.add(1,2,5);

        Volume volume3 = new Volume(VolumeType.POINTLIST,10,10,20,2.0,1.0,"Test");
        volume3.add(2,1,2);
        volume3.add(1,2,3);
        volume3.add(4,3,12);
        volume3.add(1,2,5);
    ...
    public void testHashCodeDifferentCalibration() throws IntegerOverflowException {
        Volume volume1 = new Volume(VolumeType.POINTLIST,10,10,20,2.0,1.0,"PX");
        volume1.add(1,2,3);
        volume1.add(4,3,12);
        volume1.add(2,1,2);
        volume1.add(1,2,5);

        Volume volume2 = new Volume(VolumeType.POINTLIST,10,10,20,2.1,1.0,"PX");
        volume2.add(1,2,3);
        volume2.add(4,3,12);
        volume2.add(2,1,2);
        volume2.add(1,2,5);
    ...
    public void testHashCodeDifferentUnitsCase() throws IntegerOverflowException {
        ...
        Volume volume2 = new Volume(VolumeType.POINTLIST,10,10,20,2.0,1.0,"px");
        volume2.add(1,2,3);
        volume2.add(4,3,12);
        volume2.add(2,1,2);
        volume2.add(1,2,5);
    ...
    public void testHashCodeDifferentUnits() throws IntegerOverflowException {
        ...
        Volume volume2 = new Volume(VolumeType.POINTLIST,10,10,20,2.0,1.0,"um");
        volume2.add(1,2,3);
        volume2.add(4,3,12);
        volume2.add(2,1,2);
        volume2.add(1,2,5);
    ...
    public void testEqualsDifferentPointOrder() throws IntegerOverflowException {// Verifying that the order of point placement doesn't matter
        ...
        Volume volume3 = new Volume(VolumeType.POINTLIST,10,10,20,2.0,1.0,"PX");
        volume3.add(2,1,2);
        volume3.add(1,2,3);
        volume3.add(4,3,12);
        volume3.add(1,2,5);
    ...
    public void testClearSurface() throws IntegerOverflowException {
        Volume volume = new Volume(VolumeType.POINTLIST,10,7,15,2.0,1.0,"PX");
        volume.add(1,2,3);
        volume.add(4,3,12);
        volume.add(2,1,2);
        volume.add(1,2,5);
    ...
    public void testGetSurface() throws IntegerOverflowException {
        Volume volume = new Volume(VolumeType.POINTLIST,10,10,8,2.0,1.0,"PX");
        volume.add(5,7,3);
        volume.add(5,8,3);
        volume.add(5,9,3);
        volume.add(6,7,3);
