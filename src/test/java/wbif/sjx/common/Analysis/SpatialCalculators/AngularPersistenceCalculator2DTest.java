...
public class AngularPersistenceCalculator2DTest {
    @Test
    public void testCalculateXY() throws Exception {
        ...
        TreeMap<Integer,Double> measuredValues = new AngularPersistenceCalculator2D().calculate(x,y,z,f);
        TreeMap<Integer,Double> expectedValues = new TreeMap<>();

        expectedValues.put(0,Double.NaN);
        expectedValues.put(1,0.8443);
        expectedValues.put(2,0.7377);
        expectedValues.put(3,0.9158);
        expectedValues.put(4,0.6127);
        expectedValues.put(5,0.5743);
        expectedValues.put(6,0.7634);
        expectedValues.put(7,0.3773);
