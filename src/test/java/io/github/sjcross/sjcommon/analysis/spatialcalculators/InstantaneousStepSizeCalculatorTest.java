...
import io.github.sjcross.sjcommon.analysis.spatialcalculators.InstantaneousStepSizeCalculator;
...
public class InstantaneousStepSizeCalculatorTest {
    ...
    public void testCalculator() throws Exception {
        ...
        TreeMap<Integer,Double> measuredValues = new InstantaneousStepSizeCalculator().calculate(x,y,z,f);
